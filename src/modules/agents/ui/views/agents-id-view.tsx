...
import { AgentIdViewHeader } from "../components/agen-id-view-header"
...
export const AgentIdView = ({agentId}:Props)=>{
  ...
  const [RemoveConfirmation,confirmRemove] = useConfirm("Are you sure?",`The following action will remove ${data.meetingCount} assocuated meetingd`)
      ...
      <div className="bg-white rounded-lg border">
        <div className="px-4 py-5 gap-y-5 flex flex-col col-span-5">
          ...
          <div className="flex flex-col gap-y-4 ">
            <p className="text-lg font-medium ">Instructiosn</p>
...
export const AgentIdViewLoading =()=>{return(
     <LoadingState title="Loading agents" description="please wait..."/>

  )}


  export const AgentIdViewError =()=>{return(
